...
package com.xymaplibrary.mapapi.clusterutil.clustering.view;
...
import com.xymaplibrary.mapapi.clusterutil.projection.Point;
import com.xymaplibrary.mapapi.clusterutil.projection.SphericalMercatorProjection;
import com.xymaplibrary.mapapi.clusterutil.ui.IconGenerator;
...
import static com.xymaplibrary.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
     ...
     */
    //修改了显示的等级
    private static final int[] BUCKETS = {5,10, 20, 50, 100, 200, 500, 1000,2000,5000};
    // 外部矩形弧度
